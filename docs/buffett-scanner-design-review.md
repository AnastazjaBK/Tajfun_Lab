...
**Status:** v1.14 — **Faza 0, Faza 1 i Faza 2 formalnie ukończone i dowiedzione na realnych danych.** **Faza 3 (integracja Claude API: formalny JSON Schema + wrapper klienta + prompt v0) zaimplementowana, oczekuje empirycznej weryfikacji** — pierwsza faza, która realnie kosztuje (Claude API), wymaga nowego sekretu `ANTHROPIC_API_KEY` — patrz „Status Fazy 3 (v1.14)" niżej. Ten plik jest samodzielny — nie wymaga sięgania do historii commitów.
**Data:** 2026-09-20 (v1.0–v1.4), 2026-09-21 (v1.5–v1.6), 2026-09-24–25 (v1.7–v1.14)
...
### Status Fazy 3 (v1.14) — kod zbudowany, oczekuje empirycznej weryfikacji
