...
**Status:** v1.21 — **Wszystkie Fazy 0–4 formalnie ukończone i dowiedzione na realnych danych. Faza 5.1 (prototyp point-in-time na SEC XBRL, OPEN BLOCKER 1) empirycznie potwierdzona i formalnie ukończona.** **Faza 5.2 (historyczny skład S&P 500, OPEN BLOCKER 2): plan porównania źródeł (FMP vs `fja05680/sp500`) przedstawiony do zatwierdzenia, kod jeszcze niepisany** — patrz „Plan Fazy 5.2 (v1.21)" niżej. Ten plik jest samodzielny — nie wymaga sięgania do historii commitów.
**Data:** 2026-09-20 (v1.0–v1.4), 2026-09-21 (v1.5–v1.6), 2026-09-24–25 (v1.7–v1.21)
