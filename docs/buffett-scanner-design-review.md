...
**Status:** v1.9 — **Faza 0 formalnie ukończona i dowiedziona na realnych danych** (workflow „Phase 0 Proof Run", plan Free, 3 spółki: AAPL/MSFT/KO — pełen pipeline init-db→ingest-prices→scan, poprawne CIK-i, poprawne metryki decline scannera). Po drodze: naprawiony błąd w kliencie FMP (zła rodzina endpointów `/api/v3` → `/stable`), potwierdzone empirycznie które endpointy wymagają planu Starter (tylko `sp500-constituent`, dokładnie zgodnie z pierwotnym planem — Faza 1/6, nie Faza 0), skorygowana nieścisłość z v1.7. Ten plik jest samodzielny — nie wymaga sięgania do historii commitów.
**Data:** 2026-09-20 (v1.0–v1.4), 2026-09-21 (v1.5–v1.6), 2026-09-24–25 (v1.7–v1.9)
