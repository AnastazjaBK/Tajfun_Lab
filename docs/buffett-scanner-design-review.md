...
**Status:** v1.27 — **Wszystkie Fazy 0–4 formalnie ukończone i dowiedzione na realnych danych. Faza 5.1 empirycznie potwierdzona i formalnie ukończona.** **Faza 5.2 (historyczny skład S&P 500, OPEN BLOCKER 2): krok 2 (`fja05680/sp500` + ticker→CIK) zakończony — 619/815 rozwiązanych, 100% dzisiejszych 503 aktywnych spółek. Krok 1 (FMP) zakończony — endpoint `historical-sp500-constituent` potwierdzony jako prawdziwy, ale zablokowany planem (402), dokładny wymagany tier nieustalony, właściciel zdecydował NIE kupować i szukać niezależnego darmowego/taniego trzeciego źródła zamiast tego.** Krok 3 w toku (research alternatywnych źródeł — SPY/IVV holdings i inne), decyzja o zapisie do `universe_membership` wciąż niepodjęta — patrz „Krok 1 Fazy 5.2 (v1.25–v1.27)" i „Alternatywne źródła walidacji (v1.27)" niżej. Ten plik jest samodzielny — nie wymaga sięgania do historii commitów.
**Data:** 2026-09-20 (v1.0–v1.4), 2026-09-21 (v1.5–v1.6), 2026-09-24–25 (v1.7–v1.27)
